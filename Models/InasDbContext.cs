...
// 2. Mudamos a herança para IdentityDbContext<ApplicationUser>
public partial class InasDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    // Esta propriedade abaixo acessa sua tabela antiga "user" com dados de progresso.
    ...
    {
        // 3. CRUCIAL: Esta linha deve vir PRIMEIRO.
        // Ela configura as tabelas de login, senha, roles, etc.
        ...
        modelBuilder.Entity<KanjiCategoryMap>(entity =>
        {
            ...
            entity.HasOne(d => d.Kanji)
                .WithMany(p => p.KanjiCategoryMaps)
        ...
        // Abaixo segue toda a sua configuração original intacta
        ...
        modelBuilder.Entity<KanjiDecomposition>(entity =>
        {
            ...
            entity.Property(e => e.DepthLevel)
            ...
            entity.HasOne(d => d.ComponentKanji).WithMany(p => p.KanjiDecompositionComponentKanjis)
                .HasForeignKey(d => d.ComponentKanjiId)
                .HasConstraintName("kanji_decomposition_component_kanji_id_fkey");

            entity.HasOne(d => d.ComponentRadical).WithMany(p => p.KanjiDecompositions)
                .HasForeignKey(d => d.ComponentRadicalId)
                .HasConstraintName("kanji_decomposition_component_radical_id_fkey");

            entity.HasOne(d => d.ParentKanji).WithMany(p => p.KanjiDecompositionParentKanjis)
                .HasForeignKey(d => d.ParentKanjiId)
        ...
        modelBuilder.Entity<KanjiMeaning>(entity =>
        {
            ...
            entity.HasOne(d => d.IdLanguageNavigation).WithMany(p => p.KanjiMeanings)
                .HasForeignKey(d => d.IdLanguage)
                .HasConstraintName("kanji_meaning_id_language_fk");

            entity.HasOne(d => d.Kanji).WithMany(p => p.KanjiMeanings)
                .HasForeignKey(d => d.KanjiId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<KanjiRadical>(entity =>
        {
            ...
            entity.HasOne(d => d.Kanji).WithMany(p => p.KanjiRadicals)
                .HasForeignKey(d => d.KanjiId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("kanji_radical_kanji_id_fkey");

            entity.HasOne(d => d.Radical).WithMany(p => p.KanjiRadicals)
        ...
        modelBuilder.Entity<KanjiReading>(entity =>
        {
            ...
            entity.HasOne(d => d.Kanji).WithMany(p => p.KanjiReadings)
                .HasForeignKey(d => d.KanjiId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<KanjiSimilarity>(entity =>
        {
            ...
            entity.HasOne(d => d.IdKanjiNavigation).WithMany(p => p.KanjiSimilarityIdKanjiNavigations)
                .HasForeignKey(d => d.IdKanji)
                .HasConstraintName("kanji_similaridade_id_kanji");

            entity.HasOne(d => d.IdKanjiSimilarNavigation).WithMany(p => p.KanjiSimilarityIdKanjiSimilarNavigations)
                .HasForeignKey(d => d.IdKanjiSimilar)
        ...
        modelBuilder.Entity<Lesson>(entity =>
        {
            ...
            entity.HasOne(d => d.IdKanjiNavigation).WithMany(p => p.Lessons)
                .HasForeignKey(d => d.IdKanji)
                .HasConstraintName("lesson_id_kanji_fk");

            entity.HasOne(d => d.IdRadicalNavigation).WithMany(p => p.Lessons)
                .HasForeignKey(d => d.IdRadical)
                .HasConstraintName("lesson_id_radical_fk");

            entity.HasOne(d => d.Vocabulary).WithMany(p => p.Lessons)
        ...
        modelBuilder.Entity<LevelItem>(entity =>
        {
            ...
            entity.HasOne(d => d.IdNivelNavigation).WithMany(p => p.LevelItems)
                .HasForeignKey(d => d.IdNivel)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("nivel_iten_id_nivel_fk");

            entity.HasOne(d => d.IdNivelItenObjetoNavigation).WithMany(p => p.LevelItems)
                .HasForeignKey(d => d.IdNivelItenObjeto)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<RadicalMeaning>(entity =>
        {
            ...
            entity.HasOne(d => d.IdLanguageNavigation).WithMany(p => p.RadicalMeanings)
                .HasForeignKey(d => d.IdLanguage)
                .HasConstraintName("radical_reading_id_language_fk");

            entity.HasOne(d => d.IdRadicalNavigation).WithMany(p => p.RadicalMeanings)
                .HasForeignKey(d => d.IdRadical)
        ...
        modelBuilder.Entity<ReviewHistory>(entity =>
        {
            ...
            entity.HasOne(d => d.Card).WithMany(p => p.ReviewHistories)
        ...
        modelBuilder.Entity<UserNote>(entity =>
        {
            ...
            entity.HasOne(d => d.Kanji).WithMany(p => p.UserNotes)
                .HasForeignKey(d => d.KanjiId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("usuario_anotacao_id_kanji_fkey");

            entity.HasOne(d => d.Radical).WithMany(p => p.UserNotes)
                .HasForeignKey(d => d.RadicalId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<UserProgress>(entity =>
        {
            ...
            entity.Property(e => e.Id)
                ...
                .HasColumnName("id");
            entity.Property(e => e.CardId).HasColumnName("card_id");
            entity.Property(e => e.ConsecutiveCorrectCount)
                .HasDefaultValue(0)
            ...
            entity.HasOne(d => d.Card).WithMany(p => p.UserProgresses)
                .HasForeignKey(d => d.CardId)
        ...
        modelBuilder.Entity<UserSynonym>(entity =>
        {
            ...
            entity.HasOne(d => d.Kanji).WithMany(p => p.UserSynonyms)
                .HasForeignKey(d => d.KanjiId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("usuario_sinonimo_kanji_radical_id_kanji_fkey");

            entity.HasOne(d => d.Radical).WithMany(p => p.UserSynonyms)
                .HasForeignKey(d => d.RadicalId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("usuario_sinonimo_kanji_radical_id_radical_fkey");

            entity.HasOne(d => d.User).WithMany(p => p.UserSynonyms)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Vocabulary>(entity =>
        {
            ...
            entity.HasMany(d => d.Kanjis).WithMany(p => p.Vocabularies)
                .UsingEntity<Dictionary<string, object>>(
                    "VocabularyComposition",
                    r => r.HasOne<Kanji>().WithMany()
                        .HasForeignKey("KanjiId")
                        .HasConstraintName("vocabulary_composition_kanji_id_fkey"),
                    l => l.HasOne<Vocabulary>().WithMany()
                        .HasForeignKey("VocabularyId")
                        .HasConstraintName("vocabulary_composition_vocabulary_id_fkey"),
                    j =>
                    {
                        j.HasKey("VocabularyId", "KanjiId").HasName("vocabulary_composition_pkey");
                        j.ToTable("vocabulary_composition");
                        j.IndexerProperty<int>("VocabularyId").HasColumnName("vocabulary_id");
                        j.IndexerProperty<int>("KanjiId").HasColumnName("kanji_id");
                    });
        });
        ...
        modelBuilder.Entity<VocabularyReading>(entity =>
        {
            ...
            entity.HasOne(d => d.Vocabulary).WithMany(p => p.VocabularyReadings)
                .HasForeignKey(d => d.VocabularyId)
